...
background-image: url(/files/slides/CPA_data_cleaning_2020/images/better_data_cleaning_splash_slide_section_1.png)
background-position: center
background-size: contain
---
class: inverse, center

background-image: url(/files/slides/CPA_data_cleaning_2020/images/markus-spiske-iar-afB0QQw-unsplash.jpg)
background-position: center
background-size: contain
...
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/tidyverse.png)]
...
![](/files/slides/CPA_data_cleaning_2020/images/cover.png)
]
...
.middle[.center[.img-fill-50[![](/files/slides/CPA_data_cleaning_2020/images/core_hex_stickers.png)]]]
...
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/dplyr.png)]
...
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/magrittr.png)]
...
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/readr.png)]

## Importing Data

```{r import_csv}
data_superhero <- read_csv(file = "https://raw.githubusercontent.com/Standard-Deviator/CPA_2020_data_cleaning_tidyverse/master/data/heroes_information.csv")
```
--
```{r eval=FALSE}
spec(data_superhero)
...
--
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/Mario_pipe.png)]
???
...
---
class: inverse
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/tibble.png)]
...
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/ggplot2.png)]
## Range Constraints
...
---
class: inverse
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/stringr.png)]
...
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/forcats.png)]
...
## Visualize `skin_color`
.hex-sticker[![](/files/slides/CPA_data_cleaning_2020/images/tidyr.png)]
